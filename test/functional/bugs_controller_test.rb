...
class BugsControllerTest < ActionController::TestCase
  ...
  test "should create bug" do
    assert_difference('Bug.count') do
      post :create, bug: { description: @bug.description, name: @bug.name, resolve: @bug.resolve, user_id: @bug.user_id }
    end
  ...
  test "should update bug" do
    put :update, id: @bug, bug: { description: @bug.description, name: @bug.name, resolve: @bug.resolve, user_id: @bug.user_id }
    assert_redirected_to bug_path(assigns(:bug))
  end
